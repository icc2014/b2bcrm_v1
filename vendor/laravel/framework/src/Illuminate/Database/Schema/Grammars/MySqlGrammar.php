...
use Illuminate\Support\Facades\DB;//非原生
class MySqlGrammar extends Grammar {
	...
	protected $modifiers = array('Unsigned', 'Nullable', 'Default', 'Increment', 'After', 'Comment');//Comment非原生
	/**
	 ...
	 * @return string|null
	 */
	protected function modifyComment(Blueprint $blueprint, Fluent $column) //非原生
	{
