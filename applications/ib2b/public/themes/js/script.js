var App = function () {
    ...
    c = function () {
        ...
        a = $("#sidebar"),
        i = $("body");
        e = i.hasClass("sidebar-fixed") ? $(window).height() - $("#header").height() + 1 : a.height() + 20,
    ...
    d = function () {
        jQuery(".sidebar-menu .has-sub > a").click(function () {
            ...
            i = 200,
            o = jQuery(this).next();
            o.is(":visible") ? (jQuery(".arrow", jQuery(this)).removeClass("open"), jQuery(this).parent().removeClass("open"), o.slideUp(i,
            function () {
                0 == $("#sidebar").hasClass("sidebar-fixed") && App.scrollTo(t, a),
                c()
            })) : (jQuery(".arrow", jQuery(this)).addClass("open"), jQuery(this).parent().addClass("open"), o.slideDown(i,
            function () {
                0 == $("#sidebar").hasClass("sidebar-fixed") && App.scrollTo(t, a),
                c()
            }))
    ...
    m = function () {
        ...
        jQuery(".sidebar-collapse i").removeClass(a),
        jQuery(".sidebar-collapse i").addClass(i),
    ...
    h = function () {
        s();
        "1" === $.cookie("mini_sidebar") && (jQuery(".navbar-brand").addClass("mini-menu"), jQuery("#sidebar").addClass("mini-menu"), jQuery("#main-content").addClass("margin-left-50"), t = !0),
    ...
    b = function () {
        v(),
        $(".team-status-toggle").click(function (a) {
            a.preventDefault(),
            e(this),
        ...
        $("body").click(function (t) {
            var a = t.target.className.split(" "); -1 == $.inArray("team-status", a) && -1 == $.inArray("team-status-toggle", a) && -1 == $(t.target).parents().index($(".team-status")) && 0 == $(t.target).parents(".team-status-toggle").length && e()
        }),
        ...
        t = function (e) {
            ...
            return "undefined" == typeof t && (t = "#team-status"),
            t
        }
    },
    v = function () {
    ...
    x = function () {
        ...
        jQuery(".box .tools a.reload").click(function () {
           //
			...
			//project_id = jQuery(this).attr('data-project-id');
                ...
                bootbox.dialog({
                    ...
                    buttons: {
                        success: {
                            ...
                            className: "btn-success",
                            callback: function () {
                                bootbox.alert("Congratulations! You made the right decision.",
                                function () {
                                    $(".bootbox").modal("hide")
                                })
                            }
                        ...
                        danger: {
                            ...
                            className: "btn-danger",
                            callback: function () {
                                bootbox.alert("Oops, we're sorry to hear that!",
                                function () {
                                    $(".bootbox").modal("hide")
                                })
                            }
    ...
    S = function () {
        for (var e = [], t = "New York,Los Angeles,Chicago,Houston,Paris,Marseille,Toulouse,Lyon,Bordeaux,Philadelphia,Phoenix,San Antonio,San Diego,Dallas,San Jose,Jacksonville".split(","), a = 0; a < t.length; a++) e.push({
            id: a,
            name: t[a],
            status: a % 2 ? "Already Visited" : "Planned for visit",
    ...
    z = function () {
        function e(e, t) {
            var a = $(t.handle).data("bs.tooltip").$tip[0],
            i = $.extend({},
            $(t.handle).offset(), {
            ...
            $(a).offset(tp),
            $(a).find(".tooltip-inner").text(t.value)
        }
        $("#slider").slider({
            value: 15,
            slide: e,
            ...
            jQuery.fn.anim_progressbar = function (e) {
                ...
                return this.each(function () {
                    ...
                    var n = setInterval(function () {
                        var l = r.finish - new Date,
                        c = new Date - r.start,
                        d = parseInt(l / o),
                        m = parseInt((l - d * o) / i),
                        u = parseInt((l - d * o - m * i) / a),
                        h = parseInt((l - d * o - u * a - m * i) / t),
                        p = c > 0 ? c / e * 100 : 0;
                        $(s).children(".percent").html("<b>" + p.toFixed(1) + "%</b>"),
                        $(s).children(".elapsed").html(d + " day " + m + " hr : " + u + " min : " + h + " sec remaining</b>"),
                        $(s).children(".pbar").children(".ui-progressbar-value").css("width", p + "%"),
                        p >= 100 && (clearInterval(n), $(s).children(".percent").html("<b>100%</b>"), $(s).children(".elapsed").html("Completed"))
                    },
                    r.interval)
                })
            },
            $("#progress1").anim_progressbar();
            var e = (new Date).setTime((new Date).getTime() + 5e3),
            t = (new Date).setTime((new Date).getTime() + 15e3);
        ...
        $(".knob").knob({
            ...
            draw: function () {
                if ("tron" == this.$.data("skin")) {
                    ...
                    this.o.cursor && (i = o - .3) && (o += .3),
                    this.o.displayPrevious && (e = this.startAngle + this.angle(this.v), this.o.cursor && (a = e - .3) && (e += .3), this.g.beginPath(), this.g.strokeStyle = this.pColor, this.g.arc(this.xy, this.xy, this.radius - this.lineWidth, a, e, !1), this.g.stroke()),
                    this.g.beginPath(),
                    this.g.strokeStyle = n ? this.o.fgColor : this.fgColor,
                    this.g.arc(this.xy, this.xy, this.radius - this.lineWidth, i, o, !1),
                    this.g.stroke(),
                    this.g.lineWidth = 2,
                    this.g.beginPath(),
    ...
    W = function () {
        ...
        if ($("body").on("click", '.nav.nav-tabs.tabs-left a[data-toggle="tab"], .nav.nav-tabs.tabs-right a[data-toggle="tab"]',
        function () {
            e($(this))
    ...
    H = function () {
        function e(e) {
            ...
            return void 0 !== e.posters && void 0 !== e.posters.thumbnail && (t += "<td class='movie-image'><img src='" + e.posters.thumbnail + "'/></td>"),
            t += "<td class='movie-info'><div class='movie-title'>" + e.title + "</div>",
            void 0 !== e.critics_consensus ? t += "<div class='movie-synopsis'>" + e.critics_consensus + "</div>" : void 0 !== e.synopsis && (t += "<div class='movie-synopsis'>" + e.synopsis + "</div>"),
            t += "</td></tr></table>"
        }
        function t(e) {
            return e.title
        ...
        $("#e7").select2({
            ...
            initSelection: function (e, t) {
                var a = $(e).val();
                "" !== a && $.ajax("http://api.rottentomatoes.com/api/public/v1.0/movies/" + a + ".json", {
                    data: {
                        apikey: "uekzdmffsrmqzwdtcgmc5yu9"
                    },
                    dataType: "jsonp"
    ...
    q = function () {
        ...
        $("#login_button").click(function () {
            ...
            e = $(this);
            e.text('').text('正在登陆...').delay(2000).queue(function () {
                //alert(baseurl);
                window.location = baseurl + '/back_end';
            })
        ...
        function e() {
            ...
            function () {
                ...
                $("#voiceBtn").css("position", "absolute").offset({
                    top: a.top,
                    left: a.left + $("#editor").innerWidth() - 35
                })
            } else $("#voiceBtn").hide()
        }
        function t(e, t) {
    ...
    X = function () {
        function e() {
            ...
            n = 0,
            r = d3.time.format("%A"),
            s = new xChart("line-dotted", i[o[n]], "#chart1", {
                axisPaddingTop: 5,
            ...
            document.body.appendChild(e); 
            {
                ...
                o = {
                    ...
                    mouseover: function (i) {
                        var o = $(this).offset();
                        $(e).text(d3.time.format("%A")(i.x) + ": " + i.y).css({
                            top: a + o.top,
                            left: o.left + t
                        }).show()
                    },
        ...
        function n() {
            ...
            var t = {
                enter: function (e, t, a, i) {
                    var o, n, r = xChart.visutils.getInsertionPoint(9),
                    s = i.map(function (e) {
                    ...
                    o = e._g.selectAll(".errorLine" + a).data(s,
                    function (e) {
                        return e.className
                    }),
                    o.enter().insert("g", r).attr("class",
                    function (e, t) {
    ...
    st = function () {
        $.backstretch([
                       "/themes/img/login/1.jpg",
                       "/themes/img/login/2.jpg",
                       "/themes/img/login/3.jpg",
                       "/themes/img/login/4.jpg",
                       "/themes/img/login/5.jpg",
                       "/themes/img/login/6.jpg",
                       "/themes/img/login/7.jpg",
                       "/themes/img/login/8.jpg",
                       "/themes/img/login/9.jpg",
                       "/themes/img/login/10.jpg",
                       "/themes/img/login/11.jpg",
                       "/themes/img/login/12.jpg"
                       ], {
                           duration: 3e3,
                           fade: 750
                       })
    ...
    lt = function (e) {
        var t = function () {
            ...
            a = t.val();
            if (0 != a.length) {
                var i = moment().format("YYYY-MM-DD HH:mm:ss"),
                o = "";
                ...
                o += '<h4 class="media-heading">You <span class="pull-left"><abbr id="curr-time" class="timeago" title="' + i + '" >' + i + '</abbr> <i class="fa fa-clock-o"></i></span></h4>',
                o += a,
                o += "</div>",
                o += "</li>";
                var n = $("." + e + " .chat-list");
    ...
    dt = function () {
        ...
        $("#address-book .slider-content ul li ul li a").click(function (e) {
            ...
            var t = $("#contact-card"),
            a = $(this).text();
            $("#contact-card .panel-title").html(a),
            $("#contact-card #card-name").html(a);
            var i = Math.floor(5 * Math.random()) + 1;
            $("#contact-card .headshot img").attr("src", "img/addressbook/" + i + ".jpg"),
    ...
    pt = function () {
        a && o && $("#main-content").addClass("margin-top-100"),
        !a && o && $("#main-content").removeClass("margin-top-100").addClass("margin-top-50")
    },
    ft = function () {
        function e() {
            function e(e, t, a) {
                $('<div id="tooltip">' + a + "</div>").css({
                    position: "absolute",
                    display: "none",
                    top: t + 5,
                    left: e + 15,
        ...
        function a() {
            ...
            var t = [[1, 100 * Math.random()], [2, 100 * Math.random()], [3, 100 * Math.random()], [4, 100 * Math.random()], [5, 100 * Math.random()], [6, 100 * Math.random()], [7, 100 * Math.random()], [8, 100 * Math.random()], [9, 100 * Math.random()], [10, 100 * Math.random()], [11, 100 * Math.random()], [12, 100 * Math.random()]],
            a = $(this).parent().parent().css("color"),
            i = (function () {
            });
            $("#chart-revenue").bind("plothover",
            function (t, a, o) { })
        }
        e(),
        t()
    ...
    gt = function () {
        var e = function (e) {
            $("#skin-switcher").attr("href", "/themes/css/themes/" + e + ".css"),
            $.cookie("skin_color", e)
        };
    ...
    return {
        init: function () {
            App.isPage("index") && (g(), tt(), ft(), lt("chat-window"), at(), bt(), f()),
            App.isPage("widgets_box") && ut(),
            App.isPage("elements") && (C(), S(), D(), M(), A()),
            App.isPage("button_icons") && (Q(), P()),
            App.isPage("sliders_progress") && (z(), I(), F()),
            App.isPage("treeview") && O(),
            App.isPage("nestable_lists") && N(),
            App.isPage("simple_table") && E(),
            App.isPage("dynamic_table") && B(),
            App.isPage("jqgrid_plugin") && Y(),
            App.isPage("forms") && (R(), L(), U(), H(), q(), A()),
            App.isPage("rich_text_editors") && G(),
            App.isPage("dropzone_file_upload") && V(),
            App.isPage("xcharts") && X(),
            App.isPage("others") && (K(), Z(), tt()),
            App.isPage("calendar") && (at(), q()),
            App.isPage("vector_maps") && it(),
            App.isPage("gallery") && (ot(), nt(), rt()),
            App.isPage("login") && q(),
            App.isPage("wizards_validations") && q(),
            App.isPage("login_bg") && (q(), st()),
            App.isPage("chats") && (lt("chat-window"), lt("chat-widget"), _()),
            App.isPage("todo_timeline") && ct(),
            App.isPage("address_book") && dt(),
            App.isPage("orders") && _(),
            App.isPage("faq") && mt(),
            App.isPage("user_profile") && (et(), tt(), q(), vt()),
            App.isPage("mini_sidebar") && m(),
        ...
        blockUI: function (e) {
            lastBlockedUI = e,
            jQuery(e).block({
                message: '<img src="/themes/img/loaders/720.GIF" align="absmiddle">',
                css: {
                    border: "none",
                    padding: "2px",
...
function(e) {
    e.fn.admin_tree = function(t) {
        ...
        this.each(function() {
            var t = e(this);
            t.html('<div class = "tree-folder" style="display:none;">				<div class="tree-folder-header">					<i class="' + a["close-icon"] + '"></i>					<div class="tree-folder-name"></div>				</div>				<div class="tree-folder-content"></div>				<div class="tree-loader" style="display:none"></div>			</div>			<div class="tree-item" style="display:none;">				' + (null == a["unselected-icon"] ? "": '<i class="' + a["unselected-icon"] + '"></i>') + '				<div class="tree-item-name"></div>			</div>'),
            t.addClass(1 == a.selectable ? "tree-selectable": "tree-unselectable"),
            t.tree(a)
        }),
        this
    }
